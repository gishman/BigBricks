...
class ProjectRender extends PaginatorSnippet[Project] {
  ...
  def projects(in: NodeSeq): NodeSeq = {
    ...
    page.flatMap(u => <tr>
      ...
      <td>
        {link("/components/project/edit", () => selectedProject(Full(u)), <span class="glyphicon glyphicon-edit"></span>)}{link("/components/project/delete", () => selectedProject(Full(u)), <span class="glyphicon glyphicon-remove"></span>)}
      </td>
    </tr>)
