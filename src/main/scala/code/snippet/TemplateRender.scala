...
class TemplateRender extends PaginatorSnippet[Template] {
  ...
  def templates: NodeSeq = {
    ...
    page.flatMap(u => <tr>
      ...
      <td>
        {link("/components/template/edit", () => selectedTemplate(Full(u)), <span class="glyphicon glyphicon-edit"></span>)}{link("/components/template/delete", () => selectedTemplate(Full(u)), <span class="glyphicon glyphicon-remove"></span>)}
      </td>
    </tr>)
